...
/**
 * Variation of {@link ToDoubleFunction} that returns {@code OptionalDouble} instead of the raw value.
...
@FunctionalInterface public interface OptionalToDoubleFunction<T> extends Function<T, OptionalDouble> {
	/**
	 * Variation of {@link ToDoubleFunction#applyAsDouble(Object)} that returns {@code OptionalDouble}.
	 ...
	 * 
	 * @param t
	 *            see {@link ToDoubleFunction#apply(Object)}
	...
	/**
	 * Convert this {@code OptionalToDoubleFunction} to plain {@code ToDoubleFunction} using default value.
	 * The returned {@code ToDoubleFunction} will unwrap present value from {@code OptionalDouble} if possible,
	...
	/**
	 * Convert this {@code OptionalToDoubleFunction} to plain {@code ToDoubleFunction} using fallback {@code DoubleSupplier}.
	 * The returned {@code ToDoubleFunction} will unwrap present value from {@code OptionalDouble} if possible,
